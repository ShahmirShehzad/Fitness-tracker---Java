 ...
 * @author shehz
 */
public class goalDetails extends javax.swing.JFrame {
    ...
    public goalDetails(int uid) {
        this.id = uid;
        initComponents();
        
        try {
        Class.forName("com.mysql.cj.jdbc.Driver");
        java.sql.Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/fit", "root", "");
        String sql = "SELECT current_weight, target_weight,estcalories, target_date, daily_cal_intake,days_remain FROM weightlossgoals WHERE user_id = ?";
        PreparedStatement pst = con.prepareStatement(sql);
        pst.setInt(1, getuserID()); // Use the provided userid parameter
        ...
        double estCalories = rs.getDouble("estcalories");
        Date targetDate = rs.getDate("target_date");
        double dailyCalIntake = rs.getDouble("daily_cal_intake");
        int daysRemaining = rs.getInt("days_remain");
    
        model.addRow(new Object[] {currentWeight, targetWeight, estCalories, targetDate, dailyCalIntake, daysRemaining});
        }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("View Goals History");

        ehistorytable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            },
            new String [] {
                "Current Weight","Target Weight", "Calories(est)","Target date","Daily intake","Days left"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(goalDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new goalDetails(getuserID()).setVisible(true);
            }
        });
    }
